...
class UNet(nn.Module):
    def __init__(self):
        ...
        def CBR2d(in_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=True): #Convolution BatchNormalization Regularization 2D
            layers = []
        ...
        self.fc = nn.Conv2d(in_channels=64, out_channels=2, kernel_size=1, stride=1, bias=True)
    ...
    def forward(self, x):
        ...
        enc4_1 = self.enc2_1(pool3)
        enc4_2 = self.enc2_2(enc4_1)
        pool4 = self.pool2(enc4_2)
